...
export default function Leaderboard() {
  ...
  useEffect(() => {
    fetch(`${API}/users/leaderboard`).then(r => r.json()).then(setLeaders).catch(console.error);
  }, []);
      ...
      <div className="grid-2" style={{ gap: '2rem' }}>
        ...
        <div className="card">
          ...
          <div className="d-flex flex-col gap-3">
            ...
            {leaders.map((u, i) => (
              <div key={u._id} className="d-flex align-center justify-between" style={{ padding: '1rem', background: i === 0 ? '#F0FDF4' : '#F9FAFB', borderRadius: 'var(--radius-sm)', border: i === 0 ? '2px solid var(--primary)' : '1px solid var(--border)' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontWeight: 700 }}>{u.trustScore}%</div>
        ...
        <div className="card">
          ...
          <div className="d-flex flex-col gap-4">
            {leaders.slice(0, 5).map((u, i) => (
              <div key={u._id} style={{ padding: '1rem', background: '#F9FAFB', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border)' }}>
                ...
                <div className="progress-bar">
                  <div className="progress-fill" style={{ width: `${u.trustScore}%` }}></div>
                </div>
              </div>
            ))}
